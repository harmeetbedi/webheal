...
public class Decoder {
    ...
    public static char x2c(char c1, char c2) throws Exception {
        int i1 = 0, i2 = 0;
        ...
        if ((c1 >= '0')&&(c1 <= '9')) {
            ...
            throw new Exception("InvalidURLEncoding");
        }
    ...
    public static String decodeURLEncodedUnicode(String value) throws Exception {
        ...
        while(i < n) {
            ...
            if (c == '+') c = ' ';
                ...
                else throw new Exception("InvalidURLEncoding");
            }
            else sb.append(c);
            i++;
        }
    ...
    public static String decodeURLEncoded(String value) throws Exception {
        StringBuffer sb = new StringBuffer(value.length());
        int i = 0, n = value.length();
        while(i < n) {
            char c = value.charAt(i);
            if (c == '+') c = ' ';
                ...
                if (i + 2 >= n) throw new Exception("InvalidURLEncoding");
    ...
    public static String decodeEscaped(String value) throws Exception {
